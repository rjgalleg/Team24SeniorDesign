...
public class MonthlySteps extends AppCompatActivity implements View.OnClickListener {
    private FitBitAuth fba;
    private static String WEEKLY_STEPS_URL = "https://api.fitbit.com/1/user/-/activities/steps/date/today/1m.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button = (Button) findViewById(R.id.monthly_steps_back);
        webview = (WebView) findViewById(R.id.monthly_steps_webview);
        chart = (HorizontalBarChart) findViewById(R.id.monthly_steps_chart);
...
//        yr.setInverted(true);
        ...
        fba = new FitBitAuth(webview, WEEKLY_STEPS_URL, MonthlySteps.this);
