...
public class WeeklyCalories extends AppCompatActivity implements View.OnClickListener {
    private FitBitAuth fba;
    private static String WEEKLY_CALORIES_URL = "https://api.fitbit.com/1/user/-/activities/calories/date/today/1w.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weekly_calories);

        back_button = (Button) findViewById(R.id.weekly_calories_back);
        webview = (WebView) findViewById(R.id.weekly_calories_webview);
        calories_chart = (BarChart) findViewById(R.id.calories_chart);
    ...
    private void setBarChart(){
        ...
        fba = new FitBitAuth(webview, WEEKLY_CALORIES_URL, WeeklyCalories.this);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.weekly_calories_back:
