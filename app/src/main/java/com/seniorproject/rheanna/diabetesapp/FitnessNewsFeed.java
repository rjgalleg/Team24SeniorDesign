...
public class FitnessNewsFeed extends AppCompatActivity implements PostInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fitness_news_feed);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(FitnessNewsFeed.this, FitnessPost.class));

            }

        });

        String url_string="/FitnessFetchPost.php";
    ...
    public void processFinish(String output) {
        ...
        try {
            ...
            while (count < jsonArray.length()) {
                ...
                UserPostInfo userInfo = new

                        UserPostInfo(PostID,username,title,userpost);
            ...
            myListView.setOnItemClickListener(
                    ...
                    new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int
                            ...
                            Intent intent = new Intent(FitnessNewsFeed.this,

                                    CommentNewsFeed.class);
