...
public class MedicalNewsFeed extends AppCompatActivity implements PostInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medical_news_feed);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MedicalNewsFeed.this, MedicalPost.class));
            }
        });
        String url_string="/MedicalFetchPost.php";
            ...
            myListView.setOnItemClickListener(
                    new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(MedicalNewsFeed.this, CommentNewsFeed.class);
